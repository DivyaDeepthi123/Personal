...
const About = () => {
  return (
    <section className="max-w-2xl mx-auto px-4 flex flex-col gap-5">
      <h2 className="text-[13px] font-bold lowercase tracking-tight">about</h2>
      <div className="flex flex-col gap-4 text-[13px] text-muted-foreground leading-relaxed tracking-tight">
